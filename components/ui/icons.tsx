...
function IconImport({ className, ...props }: React.ComponentProps<'svg'>) {
  return (
    <svg
      ...
      {...props}
    >
      <path xmlns="http://www.w3.org/2000/svg" d="M140.8 1017.6c-38.4 0-70.4-12.8-96-38.4-25.6-25.6-38.4-57.6-38.4-96v-185.6c0-12.8 6.4-25.6 12.8-32s19.2-12.8 32-12.8 25.6 6.4 32 12.8 12.8 19.2 12.8 32v185.6c0 12.8 6.4 32 12.8 38.4s19.2 12.8 38.4 12.8h742.4c12.8 0 32-6.4 38.4-12.8 6.4-6.4 12.8-19.2 12.8-38.4v-185.6c0-12.8 6.4-25.6 12.8-32 6.4-6.4 19.2-12.8 32-12.8s25.6 6.4 32 12.8c6.4 6.4 12.8 19.2 12.8 32v185.6c0 38.4-12.8 70.4-38.4 96-25.6 25.6-57.6 38.4-96 38.4H140.8z"/>
      <path xmlns="http://www.w3.org/2000/svg" d="M537.6 12.8c6.4 6.4 12.8 19.2 12.8 32v544c0 6.4 6.4 6.4 6.4 6.4h6.4l153.6-160c6.4-6.4 12.8-19.2 25.6-19.2s25.6 6.4 32 12.8 12.8 19.2 12.8 32-6.4 25.6-12.8 32l-224 236.8c-6.4 6.4-19.2 12.8-32 12.8s-25.6-6.4-38.4-19.2L249.6 492.8c-6.4-6.4-12.8-19.2-12.8-32 0-6.4 6.4-12.8 19.2-25.6 6.4-6.4 19.2-12.8 32-12.8 0 0 19.2 6.4 25.6 12.8l147.2 160h6.4c6.4 0 6.4-6.4 6.4-6.4V51.2c0-12.8 6.4-25.6 12.8-32s19.2-12.8 32-12.8c6.4 0 12.8 0 19.2 6.4z"/>
    </svg>
  )
}
...
function IconExport({ className, ...props }: React.ComponentProps<'svg'>) {
  return (
    <svg
      ...
      {...props}
    >
      <path xmlns="http://www.w3.org/2000/svg" d="M471 250.4c0-22.1 17.9-40.1 40.1-40.1 22.1 0 40.1 17.9 40.1 40.1V680c0 22.1-17.9 40.1-40.1 40.1-22.1 0-40.1-17.9-40.1-40.1V250.4z m0 429.5"/>
      <path xmlns="http://www.w3.org/2000/svg" d="M852.5 834V645.4c0-20.8 16.9-37.7 37.7-37.7 20.8 0 37.7 16.9 37.7 37.7v226.2c0 20.8-16.9 37.7-37.7 37.7H136.1c-20.8 0-37.7-16.9-37.7-37.7V645.4c0-20.8 16.9-37.7 37.7-37.7 20.8 0 37.7 16.9 37.7 37.7V834h678.7z m0 0M511.1 229.5L320.3 437.9c-15.1 16.4-40.5 17.4-56.9 2.4-16.4-15-17.5-40.5-2.4-56.9L481.4 143c7.6-8.4 18.4-13.1 29.7-13.1s22.1 4.8 29.6 13.1l220.4 240.4c15 16.4 14 41.9-2.4 56.9s-41.9 14-56.9-2.4L511.1 229.5z m190.7 208.4"/>
    </svg>
  )
}
